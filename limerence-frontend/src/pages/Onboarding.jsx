...
export default function Onboarding() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-purple-100 via-pink-50 to-rose-100 dark:from-purple-900 dark:via-slate-900 dark:to-black flex items-center justify-center p-6 transition-colors duration-300">
            <div className="w-full max-w-2xl">
                ...
                {step === 1 && (
                    <div className="text-center animate-fade-in">
                        <h1 className="text-4xl font-bold text-slate-800 dark:text-white mb-3">📝 Choose Your Username</h1>
                        <p className="text-slate-500 dark:text-gray-400 mb-8">This is how you'll appear in clubs and to friends</p>
                        
                        <div className="bg-white/80 dark:bg-white/5 backdrop-blur-xl rounded-3xl p-8 border border-purple-200 dark:border-white/10 shadow-xl dark:shadow-none">
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full pl-10 pr-12 py-4 bg-white dark:bg-white/10 border-2 border-purple-200 dark:border-white/20 rounded-xl text-slate-800 dark:text-white text-xl placeholder-gray-400 focus:border-purple-500 outline-none transition"
                                    maxLength={20}
                                />
                                {checkingUsername && (
                            ...
                            <p className="text-slate-500 dark:text-gray-500 text-sm mt-4">3-20 characters, letters, numbers, and underscores only</p>
                        </div>
                ...
                {step === 2 && (
                    <div className="text-center animate-fade-in">
                        <h1 class="text-4xl font-bold text-slate-800 dark:text-white mb-3">📚 Set Your Reading Goal</h1>
                        <p className="text-slate-500 dark:text-gray-400 mb-10">How many books this year?</p>
                        
                        <div className="bg-white/80 dark:bg-white/5 backdrop-blur-xl rounded-3xl p-10 border border-purple-200 dark:border-white/10 shadow-xl dark:shadow-none">
                            <div className="text-8xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-400 mb-4">
                                {yearlyGoal}
                            </div>
                            <p className="text-slate-500 dark:text-gray-400 mb-8">books per year</p>
                            
                            <input
                                type="range" min="1" max="100" value={yearlyGoal}
                                onChange={(e) => setYearlyGoal(parseInt(e.target.value))}
                                className="w-full h-3 bg-purple-100 dark:bg-gray-700 rounded-full appearance-none cursor-pointer accent-purple-500"
                            />
                            <div className="flex justify-between text-gray-500 text-sm mt-2">
                                <span>1</span><span>100</span>
                            </div>
                            <p className="text-slate-500 dark:text-gray-400 mt-6">
                                ~<span className="text-purple-400 font-bold">{Math.ceil(yearlyGoal / 12)}</span>/month
                            </p>
                        </div>
                        
                        <div className="flex gap-4 mt-8 justify-center">
                            <button onClick={() => setStep(1)} className="px-8 py-4 bg-slate-200 dark:bg-white/10 text-slate-700 dark:text-white font-bold rounded-full hover:bg-slate-300 dark:hover:bg-white/20">← Back</button>
                ...
                {step === 3 && (
                    <div className="text-center animate-fade-in">
                        <h1 className="text-4xl font-bold text-slate-800 dark:text-white mb-3">💜 Pick Your Favorites</h1>
                                ...
                                <button
                                    ...
                                    className={`p-4 rounded-2xl border-2 transition-all text-left ${
                                        selectedGenres.includes(genre)
                                            ? 'bg-purple-600/30 border-purple-500 text-slate-800 dark:text-white scale-105'
                                            : 'bg-white/80 dark:bg-white/5 border-purple-100 dark:border-transparent text-slate-600 dark:text-gray-300 hover:bg-purple-50 dark:hover:bg-white/10'
                                    }`}
                                >
                        ...
                        <div className="flex gap-4 mt-8 justify-center">
                            <button onClick={() => setStep(2)} className="px-8 py-4 bg-slate-200 dark:bg-white/10 text-slate-700 dark:text-white font-bold rounded-full hover:bg-slate-300 dark:hover:bg-white/20">← Back</button>
                            <button
                ...
                {step === 4 && (
                    <div className="text-center animate-fade-in">
                        <h1 className="text-4xl font-bold text-slate-800 dark:text-white mb-3">👥 Find Your People</h1>
                        <p className="text-slate-500 dark:text-gray-400 mb-8">Follow some readers to get started</p>
                                    ...
                                    <div
                                        ...
                                        className={`flex items-center gap-4 p-4 rounded-2xl border-2 cursor-pointer transition-all ${
                                            selectedFollows.includes(user.id)
                                                ...
                                                : 'bg-white/80 dark:bg-white/5 border-purple-100 dark:border-transparent hover:bg-purple-50 dark:hover:bg-white/10'
                                        }`}
                                    >
